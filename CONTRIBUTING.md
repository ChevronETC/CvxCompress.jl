# CvxCompress.jl contributor guidelines

## Issue reporting
If you have found a bug in CvxCompress.jl or have any suggestions for changes to
CvxCompress.jl functionality, please consider filing an issue using the GitHub
...
making changes to CvxCompress.jl. 
...
git:
  1. fork the CvxCompress.jl repository
  ...
  4. run `]test CvxCompress` in the `test` folder
